...
/**
 * This is the interface for a Cash Register which provides various operations to add money as well
 * as withdraw money from the case register. It also provides a way to maintain the history of the
 * transactions and see the content of the register.
 */
